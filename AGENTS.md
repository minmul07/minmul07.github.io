...
### Notes
- Key URLs: `/` (blog home), `/jinbao/` (client-side military-service countdown tracker — verify it by loading the page and confirming the live countdown/rank numbers update), `/privacy/kwpass/` (static privacy page for a separate app).
